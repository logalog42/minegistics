...
dofile(modpath .. DIR_DELIM .. "structures" .. DIR_DELIM .. "market.lua")
dofile(modpath .. DIR_DELIM .. "structures" .. DIR_DELIM .. "town.lua")
dofile(modpath .. DIR_DELIM .. "structures" .. DIR_DELIM .. "warehouse.lua")
dofile(modpath .. DIR_DELIM .. "structures" .. DIR_DELIM .. "workshop.lua")
