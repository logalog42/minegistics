...
local give_initial_stuff = function(player)
	...
	give_if_not_gotten_already(inv, "main", "minegistics_structures_Town")
	give_if_not_gotten_already(inv, "main", "minegistics_structures_Market")
	give_if_not_gotten_already(inv, "main", "minegistics_structures_Collector")
	give_if_not_gotten_already(inv, "main", "minegistics_structures_Factories")
   give_if_not_gotten_already(inv, "main", "minegistics_structures_Warehouse")
